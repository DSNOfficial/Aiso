...
const removeFile1 = async (fileName) => {
    try {
...
const getPermissionByRoleMenu = (RoleName) => {
  var data = {
    IT: [
      ...
      {
        route: "servicepackagelabor"
      },
       {
        route: "servicepartcontact"
      },
