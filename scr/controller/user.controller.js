...
const create = async (req, res) => {
    try {
        ...
        res.json({ message: 'បង្កើតទទួលបានជោគជ័យ', data });
    } catch (err) {
...
const update = async (req, res) => {
  ...
  remove_image
    ...
    return res.json({
      message: data.affectedRows !== 0 ? "កែប្រែទទួលបានជោគជ័យ!" : "User not found",
      data
    });
  } catch (err) {
...
const remove = async (req, res) => {
    try {
        ...
        res.json({ message: data.affectedRows !== 0 ? "លុបបានជោគជ័យ" : "User not found", data });
    } catch (err) {
